    ...
    <div className="space-y-6 max-w-7xl mx-auto transition-colors">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-5 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-end justify-center gap-2.5">
            <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 w-full justify-end">
              ...
              <div className="bg-white/95 text-slate-900 px-4 py-2.5 rounded-2xl shadow-lg border border-white/40 flex-1 sm:flex-initial min-w-[155px]">
                <div className="flex items-center justify-between text-[11px] font-bold text-slate-500 mb-1 gap-2">
                  <div className="flex items-center gap-1">
                    <span>Today's Target</span>
                    {solvedQ >= targetQ && targetQ > 0 && (
                      <span className="text-[9px] bg-emerald-100 text-emerald-800 font-black px-1.5 py-0.5 rounded-md border border-emerald-300">
                        +50 XP 🏆
                      </span>
                    )}
                  </div>
                  <span className={`font-extrabold ${solvedQ >= targetQ ? 'text-emerald-700' : 'text-blue-700'}`}>
                    {solvedQ}/{targetQ} Qs
                  </span>
                </div>
      ...
      <div className="flex flex-col lg:flex-row items-stretch gap-4 sm:gap-5">
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
          ...
          <div
            onClick={() => onNavigate('practice')}
            className="relative overflow-hidden bg-gradient-to-br from-blue-100/80 via-blue-50/40 to-sky-100/50 dark:from-blue-950/70 dark:via-dark-card dark:to-slate-900 border-2 border-blue-300/90 dark:border-blue-700/60 hover:border-blue-600 dark:hover:border-blue-400 rounded-3xl p-5 sm:p-6 shadow-sm hover:shadow-xl hover:-translate-y-0.5 transition-all cursor-pointer group flex flex-col justify-between"
          >
            {/* Rich Dynamic Target Watermark */}
            <div className="absolute right-0 top-0 bottom-0 w-60 pointer-events-none opacity-30 dark:opacity-35 select-none text-blue-600 dark:text-blue-400 flex items-center justify-end pr-1 transition-transform group-hover:scale-110 duration-500">
              <svg viewBox="0 0 200 200" className="w-full h-full" fill="none" stroke="currentColor">
                <circle cx="150" cy="100" r="85" strokeWidth="6" strokeDasharray="8 6" />
                <circle cx="150" cy="100" r="60" strokeWidth="5" />
                <circle cx="150" cy="100" r="35" strokeWidth="4" fill="currentColor" fillOpacity="0.15" />
                <circle cx="150" cy="100" r="14" strokeWidth="3" fill="currentColor" fillOpacity="0.4" />
                <path d="M150 15v170M65 100h170" strokeWidth="2" strokeDasharray="4 4" />
              </svg>
            </div>

            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3.5">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-md shadow-blue-600/30 flex items-center justify-center group-hover:scale-105 transition-transform">
                  <Target className="w-6 h-6" />
                </div>
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-950 border border-emerald-300 dark:border-emerald-800 text-[10px] font-black text-emerald-900 dark:text-emerald-300 uppercase tracking-wide shadow-2xs">
            ...
            <div className="relative z-10 flex items-center justify-between pt-4 mt-3 border-t border-blue-200/80 dark:border-slate-800">
              <button
                type="button"
                onClick={(e) => {
                  e.stopPropagation();
                ...
                className="inline-flex items-center gap-1 text-[11px] font-extrabold px-3 py-1.5 rounded-xl bg-white dark:bg-blue-950/90 hover:bg-blue-100 dark:hover:bg-blue-900 text-blue-800 dark:text-blue-300 border border-blue-300 dark:border-blue-800 shadow-2xs transition-colors cursor-pointer"
              >
                <Zap className="w-3 h-3 text-amber-500" />
                <span>Quick 10</span>
              </button>
              <div className="flex items-center gap-1 text-xs font-black text-blue-700 dark:text-sky-400 group-hover:translate-x-1 transition-transform">
                <span>Start</span>
                <ArrowRight className="w-4 h-4" />
              </div>
            </div>
          ...
          <div
            ...
            className="relative overflow-hidden bg-gradient-to-br from-purple-100/80 via-fuchsia-50/40 to-purple-100/50 dark:from-purple-950/70 dark:via-dark-card dark:to-slate-900 border-2 border-purple-300/90 dark:border-purple-700/60 hover:border-purple-600 dark:hover:border-purple-400 rounded-3xl p-5 sm:p-6 shadow-sm hover:shadow-xl hover:-translate-y-0.5 transition-all cursor-pointer group flex flex-col justify-between"
          >
            {/* Rich Document Watermark */}
            <div className="absolute right-0 top-0 bottom-0 w-56 pointer-events-none opacity-30 dark:opacity-35 select-none text-purple-600 dark:text-purple-400 flex items-center justify-end pr-2 transition-transform group-hover:scale-110 duration-500">
              <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M24 12h36l20 20v56H24z" fill="currentColor" fillOpacity="0.12" />
                <path d="M60 12v20h20" strokeWidth="2.5" />
                <line x1="34" y1="44" x2="70" y2="44" strokeWidth="3.5" strokeLinecap="round" />
                <line x1="34" y1="56" x2="70" y2="56" strokeWidth="3.5" strokeLinecap="round" />
                <line x1="34" y1="68" x2="56" y2="68" strokeWidth="3.5" strokeLinecap="round" />
              </svg>
            </div>

            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3.5">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-600 to-indigo-800 text-white shadow-md shadow-purple-600/30 flex items-center justify-center group-hover:scale-105 transition-transform">
                  <FileText className="w-6 h-6" />
                </div>
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-100 dark:bg-purple-950 border border-purple-300 dark:border-purple-800 text-[10px] font-black text-purple-900 dark:text-purple-300 uppercase tracking-wide shadow-2xs">
            ...
            <div className="relative z-10 flex items-center justify-between pt-4 mt-3 border-t border-purple-200/80 dark:border-slate-800">
              ...
              <div className="flex items-center gap-1 text-xs font-black text-purple-700 dark:text-purple-400 group-hover:translate-x-1 transition-transform">
                <span>Upload</span>
                <ArrowRight className="w-4 h-4" />
              </div>
            </div>
          ...
          <div
            ...
            className="relative overflow-hidden bg-gradient-to-br from-emerald-100/80 via-teal-50/40 to-emerald-100/50 dark:from-emerald-950/70 dark:via-dark-card dark:to-slate-900 border-2 border-emerald-300/90 dark:border-emerald-700/60 hover:border-emerald-600 dark:hover:border-emerald-400 rounded-3xl p-5 sm:p-6 shadow-sm hover:shadow-xl hover:-translate-y-0.5 transition-all cursor-pointer group flex flex-col justify-between"
          >
            {/* Rich Clock Dial Watermark */}
            <div className="absolute right-0 top-0 bottom-0 w-56 pointer-events-none opacity-30 dark:opacity-35 select-none text-emerald-600 dark:text-emerald-400 flex items-center justify-end pr-2 transition-transform group-hover:scale-110 duration-500">
              <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" stroke="currentColor" strokeWidth="2.5">
                <circle cx="50" cy="50" r="40" fill="currentColor" fillOpacity="0.12" strokeWidth="3" />
                <circle cx="50" cy="50" r="32" strokeDasharray="3 3" />
                <path d="M50 18v-8m-12 0h24" strokeWidth="3" strokeLinecap="round" />
                <path d="M50 50l18-18" strokeWidth="3.5" strokeLinecap="round" />
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3.5">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-700 text-white shadow-md shadow-emerald-600/30 flex items-center justify-center group-hover:scale-105 transition-transform">
            ...
            <div className="relative z-10 flex items-center justify-between pt-4 mt-3 border-t border-emerald-200/80 dark:border-slate-800">
              <span className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-700 dark:text-slate-300">
                <Shield className="w-3.5 h-3.5 text-emerald-700 dark:text-emerald-400" />
                <span>Strict Countdown</span>
              </span>
              <div className="flex items-center gap-1 text-xs font-black text-emerald-700 dark:text-emerald-400 group-hover:translate-x-1 transition-transform">
                <span>Launch</span>
                <ArrowRight className="w-4 h-4" />
              </div>
            </div>
          ...
          {/* CARD 4: Progress & Mistake (Enhanced Dark & Rich Golden-Amber Theme) */}
          <div
            onClick={() => onNavigate('progress')}
            className="relative overflow-hidden bg-gradient-to-br from-amber-200/90 via-orange-100/70 to-amber-100/80 dark:from-amber-950/80 dark:via-dark-card dark:to-orange-950/60 border-2 border-amber-400 dark:border-amber-600/80 hover:border-amber-600 dark:hover:border-amber-400 rounded-3xl p-5 sm:p-6 shadow-md hover:shadow-xl hover:-translate-y-0.5 transition-all cursor-pointer group flex flex-col justify-between"
          >
            {/* Rich Dark Growth Chart Watermark */}
            <div className="absolute right-0 top-0 bottom-0 w-60 pointer-events-none opacity-40 dark:opacity-45 select-none text-amber-600 dark:text-amber-400 flex items-center justify-end pr-2 transition-transform group-hover:scale-110 duration-500">
              <svg viewBox="0 0 120 120" className="w-full h-full" fill="none" stroke="currentColor">
                <path d="M12 105h96" strokeWidth="3.5" strokeLinecap="round" />
                <line x1="12" y1="20" x2="12" y2="105" strokeWidth="2.5" strokeDasharray="3 3" />
                <rect x="22" y="70" width="14" height="35" rx="3" fill="currentColor" fillOpacity="0.3" strokeWidth="2" />
                <rect x="42" y="52" width="14" height="53" rx="3" fill="currentColor" fillOpacity="0.4" strokeWidth="2" />
                <rect x="62" y="34" width="14" height="71" rx="3" fill="currentColor" fillOpacity="0.5" strokeWidth="2" />
                <rect x="82" y="16" width="14" height="89" rx="3" fill="currentColor" fillOpacity="0.65" strokeWidth="2" />
                <path d="M29 65l20-18 20-18 20-18" strokeWidth="3.5" strokeLinecap="round" />
                <circle cx="29" cy="65" r="4" fill="currentColor" />
                <circle cx="49" cy="47" r="4" fill="currentColor" />
                <circle cx="69" cy="29" r="4" fill="currentColor" />
                <circle cx="89" cy="11" r="5" fill="#f59e0b" stroke="#fff" strokeWidth="2" />
              </svg>
            </div>

            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3.5">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500 via-orange-500 to-amber-600 text-white shadow-lg shadow-amber-500/35 flex items-center justify-center group-hover:scale-105 transition-transform">
                  <TrendingUp className="w-6 h-6" />
                </div>
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-300/90 dark:bg-amber-900/90 border border-amber-500/80 dark:border-amber-600 text-[10px] font-black text-amber-950 dark:text-amber-200 uppercase tracking-wide shadow-2xs">
                  <span className="font-black text-amber-800 dark:text-amber-300">★</span> Analytics
                </span>
              </div>

              <h3 className="text-base sm:text-lg font-black font-display text-slate-900 dark:text-white group-hover:text-amber-700 dark:group-hover:text-amber-300 transition-colors">
                Progress & Mistake
              </h3>
            ...
            <div className="relative z-10 flex items-center justify-between pt-4 mt-3 border-t border-amber-300/90 dark:border-slate-800">
              <span className="inline-flex items-center gap-1.5 text-xs font-black text-amber-900 dark:text-amber-300">
                <TrendingUp className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400" />
                <span>Track • Improve • Excel</span>
              </span>
              <div className="flex items-center gap-1 text-xs font-black text-amber-800 dark:text-amber-300 group-hover:translate-x-1 transition-transform">
                <span>Review</span>
                <ArrowRight className="w-4 h-4" />
              </div>
            </div>
