...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto transition-colors">
      ...
      {/* ========================================================================= */}
      <section className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#071A35] via-[#0B2A55] to-[#0A2246] border border-white/10 shadow-xl p-6 sm:p-8 lg:p-10 text-white">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-5">
            {/* Target Exam Badge */}
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-bold text-sky-200 shadow-xs">
              <Target className="w-3.5 h-3.5 text-sky-400" />
              <span>{currentExamLabel}</span>
            </div>

            {/* Main Headline */}
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black font-display tracking-tight text-white leading-[1.15]">
              Your {currentExamLabel.includes('UPSC') ? 'UPSC' : currentExamLabel} Journey<br />
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-semibold text-white shadow-2xs">
                🎯 MCQs
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-semibold text-white shadow-2xs">
                📝 Answer Writing
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2.5 bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-extrabold text-xs sm:text-sm px-6 py-3 rounded-full shadow-lg shadow-blue-500/25 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 flex flex-col items-center lg:items-end gap-4">
            ...
            <div className="flex flex-wrap items-center justify-end gap-3 w-full">
              ...
              <div className="bg-white/95 dark:bg-slate-900/90 backdrop-blur-md rounded-2xl p-3 sm:p-3.5 shadow-xl border border-white/20 dark:border-slate-800 flex items-center gap-3 text-slate-900 dark:text-white shrink-0">
                <div className="w-9 h-9 rounded-xl bg-amber-50 dark:bg-amber-950/60 border border-amber-200/80 dark:border-amber-800 flex items-center justify-center text-amber-500">
                  <Flame className="w-5 h-5 fill-amber-500 text-amber-500" />
                </div>
                <div>
                  <div className="text-base sm:text-lg font-black leading-tight text-slate-900 dark:text-white">
                    {summary.streak} Days
                  </div>
                  <div className="text-[10px] text-amber-700 dark:text-amber-400 font-extrabold uppercase tracking-wider">
                    Active Streak
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/95 dark:bg-slate-900/90 backdrop-blur-md rounded-2xl p-3 sm:p-3.5 shadow-xl border border-white/20 dark:border-slate-800 min-w-[170px] text-slate-900 dark:text-white shrink-0">
                <div className="flex items-center justify-between text-xs mb-1.5 gap-2">
                  <span className="text-[11px] text-slate-500 dark:text-slate-400 font-semibold">Today's Target</span>
            ...
            {/* Educational Visual: UPSC Books & Laptop Study Desk */}
            <div className="w-full rounded-2xl overflow-hidden shadow-2xl border border-white/15 relative aspect-[16/10] max-h-[260px] group">
              <img
              ...
              <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-[11px] text-white/90 font-bold backdrop-blur-xs px-3 py-1.5 rounded-xl bg-black/30 border border-white/10">
